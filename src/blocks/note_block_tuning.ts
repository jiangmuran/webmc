...
const INSTRUMENT_BELOW: Record<string, Instrument> = {
  ...
  'webmc:gravel': 'snare',
  'webmc:glass': 'hat',
  'webmc:stone': 'bass_drum',
  'webmc:obsidian': 'bass_drum',
  'webmc:netherrack': 'bass_drum',
  'webmc:clay': 'flute',
  ...
  'webmc:emerald_block': 'bit' as unknown as Instrument,
...
export function instrumentBelow(blockId: string): Instrument {
  ...
  return INSTRUMENT_BELOW[blockId] ?? 'piano';
}
