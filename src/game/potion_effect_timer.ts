...
// alloc is pure waste.
// Wiki (minecraft.wiki/w/Effect): canonical beneficial-effect list.
// Added `haste` (mining/attack speed) which was missing — beacons can
// grant it as a primary, so its category matters for HUD coloring.
