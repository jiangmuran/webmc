...
describe('piglin gold', () => {
  ...
  it('chest opening overrides neutrality', () => {
    ...
    expect(piglinShouldAggro(s, ['webmc:golden_helmet'])).toBe(true);
  });
  ...
  it('wearingGoldArmor needs one gold piece', () => {
    ...
    expect(wearingGoldArmor(['webmc:leather_helmet', 'webmc:golden_boots'])).toBe(true);
  });
});
